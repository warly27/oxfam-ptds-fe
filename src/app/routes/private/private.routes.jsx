...
const PartnersCodeModule = lazy(() =>
  import("../../views/codes/partner/PartnerCodeTable")
);
const ProjectsCodeModule = lazy(() =>
  import("../../views/codes/project/ProjectCodeTable")
);
const IndicatorsCodeModule = lazy(() =>
  import("../../views/codes/indicator/IndicatorCodeTable")
);
const ActivitiesModule = lazy(() =>
  import("../../views/activities/AppActivityTable")
);
